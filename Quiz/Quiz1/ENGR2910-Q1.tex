...
For linear circuits what does the phrase "power balance" refer to?

\vspace{1.5in}
\noindent
{\bf Question 2} [2]

Write down the mathematical definition of voltage and express the value of 1 volt in alternative SI units.

\vspace{0.75in}
\noindent
{\bf Question 3} [2]

Write down the mathematical definition of current and express the value of 1 ampere in alternative SI units.

\vspace{0.75in}
\noindent
{\bf Question 4} [4]

The references for the voltage and current at the terminals of a circuit element are shown below: 

\begin{figure}[h!]
\centering
\includegraphics[width=2.5in]{P1-15.png}
\end{figure}

The values are:- $v = -20$ V and $i$ = 5 A.

\begin{itemize}

\item[(a)]

Calculate the power at the terminals and state whether the power is being absorbed or delivered by the elelment.

\vspace{1.5in}
\item[(b)]

Do the electrons gain or lose energy as they pass through the element?
