...
Consider the following function: $f(t) = 10 t e^{-5t}$, for $t > 0$.
\bit

\item[(i)]

Briefly explain in words what happens at small values of t, then at large values of t.

\vspace{1.5in}
\item[(ii)] 

Calculate the derivative of $f(t)$ with respect to $t$: $f'(t)$.

\vspace{1.5in}
\item[(iii)] 

Compute the value of $t$ that satisfies the equation: $f'(t) = 0$ and then compute $f(t)$ for this value of $t$. Give your answers below.

\vspace{1.5in}

\item[(iv)] 

Hence, sketch a graph of $f(t)$.
